...
export function AssistanceOverlay({ page, reason, onResolve }: AssistanceOverlayProps) {
  ...
  const reasonText =
    reason === 'inactivity'
      ? t('assistanceOverlay.reasonInactivity')
      : t('assistanceOverlay.reasonOther');
