                ...
                <div className="p-8 sm:p-12 flex items-center">
                    <div className="w-full">
                        <form onSubmit={handleSignIn} className="space-y-4">
                            ...
                            <Button type="submit" size="lg" className="w-full mt-4 bg-gradient-to-br from-primary to-violet-400 text-white hover:shadow-primary/30 hover:shadow-xl transition-all duration-300 transform hover:scale-105">
